"""
 Problem from: http://www.pythonchallenge.com/pc/def/equality.html
"""

def get_code():
    return get_raw().replace('\n', '')
...
def find():
    ...
    while i < len(s)-10:
        ...
        if test[0].islower() and test[-1].islower():
            test = test[1:-1]
            if test[:3].isupper() and test[3].islower() and test[-3:].isupper():
